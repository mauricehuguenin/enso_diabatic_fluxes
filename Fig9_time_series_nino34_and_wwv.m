...
for i = (first_num+1):ts_len % load in subsequent years and concatenate
    ...
    thetao = cat(3,thetao, squeeze(permute(getnc([base 'output0' a '/ocean/ocean.nc'], ...
...
%% plotting routine simulated and observed N34 as well as simulated and observed WWV anomalies
boom;
directory = '/home/z5180028/MSC_thesis/access_figures/';
...
ylabel(hAx(1),['N34 [$^{\circ}$C]'],'interpreter','latex', 'Fontsize', 21,...
    'color', RdYlBu(50,:), 'linewidth', 2.5); hold on;

ylabel(hAx(2), 'WWV [m$^3$]', 'interpreter', 'latex','FontSize',21, ...
