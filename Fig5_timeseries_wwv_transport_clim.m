...
delta_t = 30*24*60*60;
dV = diff(dV) / delta_t / 1e6 % nochmals durch 1 Million um schön in Sverdrup zu plotten
...
for t = 1:72
    GJc(:,:,t) = (massc(:,:,t)) .* wwv_mask_2S_borneo .* 1e-3 ./ 1e6; % umrechnen von [kg s�?�1] zu [m^3 s^-1]
