...
elseif i == 2
% El Nino 1997 
    [c4,h4] = contour(Xm,-Zm,isotherm_iENm,[20 20],'color',RdYlBu(8,:),'linewidth',2.5); hold on;
% La Nina 1998
    [c5,h5] = contour(Xm,-Zm,isotherm_iLNm,[20 20],'color',RdYlBu(52,:),'linewidth',2.5); hold on;
...
set(gca,'XTickLabel',{'$140^{\circ}$E','$160^{\circ}$E','$180^{\circ}$','$160^{\circ}$W','$140^{\circ}$W', ...
                         '$120^{\circ}$W', '$100^{\circ}$W', '$80^{\circ}$W'}, ...
...
h77 = legend([h4 h6 h5 h7], ...
	'ideal. El Ni\~no', ...
    'El Ni\~no 1997 ORA-S5', ...
    'ideal. La Ni\~na', ...
    'La Ni\~na 1998 ORA-S5', ...
    'location', 'southeast', 'orientation', 'vertical');
...
if i == 1
    text(-240, 32, 'a) Climatological 20$^{\circ}$C isotherm depth','interpreter', ...
        'latex', 'Fontsize', 23, 'color', [0 0 0]);
elseif i == 3
    text(-240, 32, 'c) Climatological 20$^{\circ}$C isotherm depth','interpreter', ...
        'latex', 'Fontsize', 23, 'color', [0 0 0]);
end
